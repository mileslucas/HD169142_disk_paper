...
#     ncomps = 10:2:20
#     res_pcrdi[:, :, wl_idx] = ipca(target, angles, ref; ncomps, iter_per_comp=10:15)
# end
DS9.set(res_pcrdi)
DS9.set(mask_circle(collapse(res_pcrdi; method=mean), 12; fill=NaN))

save(datadir("20240729_HD169142_vampires_loci_pcrdi.fits"), AstroImage(res_pcrdi))
save(datadir("20240729_HD169142_vampires_loci_pcrdi_coll.fits"), AstroImage(collapse(res_pcrdi, method=mean)))
