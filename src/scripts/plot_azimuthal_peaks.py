...
if __name__ == "__main__":
    ...
    for folder_idx, folder in enumerate(tqdm.tqdm(folders)):
        ...
        axes[folder_idx, 0].plot(
            inner_group["azimuth(deg)"],
            inner_group["peak_location(au)"],
            shadedata=inner_group["peak_location_err(au)"],
            c="C1",
        )
        ...
        axes[folder_idx, 1].plot(azimuth_deg, r_peaks_au, shadedata=r_peak_errs_au, c="C1")
