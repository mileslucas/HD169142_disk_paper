...
if __name__ == "__main__":
    ...
    alma_data, alma_hdr = fits.getdata(
        paths.data / alma_folder / "HD169142.selfcal.concat.GPU-UVMEM.centered_mJyBeam.fits",
        header=True,
    )
    ...
    ax.text(0.03, 0.97, labels[0], transform="axes", c="w", fontweight="bold", ha="left", va="top")
    ax.text(
        0.99,
        0.97,
        " ".join(labels[1:]),
