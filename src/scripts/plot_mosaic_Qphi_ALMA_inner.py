...
if __name__ == "__main__":
    ...
    fig.savefig(paths.figures / "HD169142_Qphi_mosaic_inner.pdf", bbox_inches="tight")
    ...
    fig.savefig(paths.figures / "HD169142_Qphi_ALMA_mosaic_inner.pdf", bbox_inches="tight")
