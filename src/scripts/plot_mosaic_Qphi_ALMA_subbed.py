...
if __name__ == "__main__":
    ...
    for i, folder in enumerate(folders):
        Qphi_image_subbed = fits.getdata(
            paths.data / folder / f"{folder}_HD169142_Qphi_cADI_sim_r2_scaled.fits"
        )
        radius_path = (
    ...
    fig.savefig(
        paths.figures / "HD169142_Qphi_mosaic_outer_subbed.pdf", bbox_inches="tight", dpi=300
    )
    ...
    fig.savefig(
        paths.figures / "HD169142_Qphi_ALMA_mosaic_outer_subbed.pdf", bbox_inches="tight", dpi=300
    )
