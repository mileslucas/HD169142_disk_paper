...
if __name__ == "__main__":
    ...
    ## Plot and save
    width = 3.31314
    fig, axes = pro.subplots(nrows=1, ncols=2, width=f"{width}in", wspace=0.75, share=False)
    ...
    axes[0].format(xlabel="x (rad)", ylabel="y", title="Data")
    axes[1].format(
        xlabel="Offset (rad)",
        yformatter="none",
        # xlocator=1,
    ...
    fig.savefig(paths.figures / "test_profiles_crosscorr.pdf", bbox_inches="tight", dpi=300)
