...
# tot_intensity = AstroImage(datadir("20230707", "diskmap", "20230707_HD169142_vampires_diskmap_total_intensity.fits"))
...
save(datadir("20230707_HD169142_vampires_ipca_rdi.fits"), AstroImage(res_rdi))
save(datadir("20230707_HD169142_vampires_ipca_rdi_coll.fits"), AstroImage(collapse(res_rdi)))
...
save(datadir("20230707_HD169142_vampires_ipca_adi+rdi.fits"), AstroImage(res_ardi))
save(datadir("20230707_HD169142_vampires_ipca_adi+rdi_coll.fits"), AstroImage(collapse(res_ardi)))
...
save(datadir("20230707_HD169142_vampires_nmf$(opt_nmf.ncomps).fits"), AstroImage(residual))
